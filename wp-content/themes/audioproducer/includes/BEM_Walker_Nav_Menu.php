...
class BEM_Walker_Nav_Menu extends Walker_Nav_Menu {
  ...
  public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
    ...
    foreach ( $classes[0] as $class ) {
      if ( $class ) {
        $item_classes[] = $block . '__item_' . $class;
      }
    }
    if ( is_single() ) {
    ...
    $args = apply_filters( $block . '_menu_item_args', $args, $item, $depth );
    ...
    $atts = apply_filters( $block . '_menu_link_attributes', $atts, $item, $args, $depth );
    ...
    $title = apply_filters( $block . '_menu_item_title', $title, $item, $args, $depth );
    ...
    $output .= apply_filters( 'walker_' . $block . '_menu_start_el', $item_output, $item, $depth, $args );
  }
